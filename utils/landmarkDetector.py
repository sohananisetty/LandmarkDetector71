...
class LandmarkDetector71:
    ...
    def __init__(self, num_lmks = 71, checkpoint_dir = "./pretrained_models/"):
    ...
    def get_landmarks_71(self, image):
        ...
        try:
            ...
            if landmarks68 is not None:
                ...
                print("lmk68 did not work, continuing with lmk71")
        except:
            pass
    ...
    def detect_landmarks(self , image):
        ...
        landmarks71[:, 1] = landmarks71[:, 1] * cropped_image.shape[0] / resized_image.shape[0] + 3
